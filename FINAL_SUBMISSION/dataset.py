...
class LuxDataset(Dataset):
    ...
    def __getitem__(self, idx) -> DatasetOutput:
        ...
        action_array = np.ones((self.map_size, self.map_size)).astype(np.int32) * UnitAction.MOVE_CENTER
        ...
        city_action_array = np.ones((self.map_size, self.map_size)).astype(np.int32) * CitytileAction.DO_NOTHING
